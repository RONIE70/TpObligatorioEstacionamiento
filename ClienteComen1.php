...
table {     font-family: "Lucida Sans Unicode", "Lucida Grande", Sans-Serif;
    font-size: 12px;    margin: 45px;     width: 680px; text-align: left;    border-collapse: collapse; }
...
tr:hover td { background: #d0dafd; color: #339; }
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><!-- sidebar menu -->
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="">
                        <a href="categories.php"><i class="fa fa-align-left"></i> Comentarios</a>
                    </li>
    ...
    <div class="right_col" role="main"> <!-- page content -->
        <div class="">
            ...
            <?php
            Cliente::CrearTablaComentarioCliente();
            include "ClienteComentariosListado.php";
            ?>
            </div></div>
          </form>
   </div>
