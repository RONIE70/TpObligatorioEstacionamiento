        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu"><!-- sidebar menu -->
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="">
                        <a href="ticketsColab.php"><i class="fa fa-area-chart"></i> Reportes</a>
                    </li>
                    ...
                    <li class="">
                        ...
                        <div class="dropdown-menu dropdown-usermenu pull-right">
                            <li><a href="colab.php"><i class="fa fa-user"></i> Mi cuenta</a></li>
                             ...
                             <li> <a class="btn btn-outline-primary " href="blogHome.php" id="botonVolver">Volver</a></li>
                        </div>
                    </li>
                </ul>
            </nav>
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="action/upd_profile.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="name" id="first-name" class="form-control col-md-7 col-xs-12" value="<?php echo $_COOKIE["USUARIOBLOG"]; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Codigo de Usuario 
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="email" class="form-control col-md-7 col-xs-12" value="<?php echo $_COOKIE["MAILUSUARIOBLOG"]; ?>">
                                        </div>
                                    </div>
