...
<body id="body">
  ...
  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    ...
    <div id="lead">
    <p><li>En esta pantalla el usuario podra dar de alta una nueva patente</li><li> Se visualiza un listado de los vehiculos estacionados con su hora de ingreso</li></p>
  </div>
  </div>
      <div class="container">
        <div class="row">
