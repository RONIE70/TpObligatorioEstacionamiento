  <?php
    ...
    $pfini=$_GET["start_at"];
    $pffin=$_GET["finish_at"];
    $miArray=Usuario::fechaMensaje($pfini, $pffin); 
 ?>
...
<html lang="en">
    <head>
        ...
        <title>Dashboard -<?php echo $_COOKIE["USUARIO"]; ?> </title>
    ...
    <div class="right_col" role="main"> <!-- page content -->
        <div class="">
            <div class="page-title">
              ...
              <div id="tableUser">
            <?php
            Usuario::CrearListado($miArray);
            include "Parcial2Listado.php";
            ?>
            </div>
          </form>
   </div>
