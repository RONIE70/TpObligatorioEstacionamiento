<?php
      ...
      if(isset($_POST['username']) && isset($_POST['password']))
     {
        ...
        $row = Usuario::ExisteusuarioLoginBlog($nombre,$password);
        ...
        if ($row == true)
        {
            ...
            $rol = $row[1];
            $_SESSION['rol'] = $rol;
            setcookie("USUARIOBLOG",$row[2]);
            setcookie("IDUSUARIOBLOG",$row[0]);
            setcookie("MAILUSUARIOBLOG",$row[4]);
...
<div class="register-box">
  <div class="register-logo">
    <a href=""><b>BLOG</b>ADMINISTRACION</a>
  </div>
