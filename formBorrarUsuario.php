...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/formBorrarUsuario.css">
...
<form id="form" class="form-signin" action="hacerBorrarUsuario.php" method="post">
  <a href="/"><img class="mb-4" src="https://image.flaticon.com/icons/png/512/753/753210.png" alt="" width="90" height="90"></a>
  <h1 class="h3 mb-3 font-weight-normal">BAJA DE USUARIO</h1>
  <label for="inputName" class="sr-only">Nombre Usuario</label>
  <input name="nombre" type="text" id="inputName" class="form-control" placeholder="Ingrese su nombre" required>
  ...
  <button class="btn btn-lg btn-primary btn-block" type="submit">BAJA</button>
