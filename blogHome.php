...
<link rel="shortcut icon" type="image/png" href="https://www.esan.edu.pe/conexion/favicon.ico" />
...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
        <a class="btn btn-sm btn-outline-secondary" href="administradorFrmUsuarios.php">Salir</a>
      </div>
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" ><img class= "img" src="./icon/portada.png" height="80">Blog Interno</a>
      </div>
      <div class="col-4 d-flex justify-content-end align-items-center">
        <a class="text-muted" href="#" aria-label="Search">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="mx-3" role="img" viewBox="0 0 24 24" focusable="false"><title>Search</title><circle cx="10.5" cy="10.5" r="7.5"/><path d="M21 21l-5.2-5.2"/></svg>
        </a>
        <a class="btn btn-sm btn-outline-secondary" href="loginBlog.php">Login Usuario</a>
      </div>
    </div>
  </header>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="btn btn-sm btn-outline-secondary" href="#">Administrador</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Encargado</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Operarios</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Novedades</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Opinion</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Familiar</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Social</a>
      <a class="btn btn-sm btn-outline-secondary" href="#">Viajes</a>
    </nav>
  </div>
  <div id="titulo">
  <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 font-italic">El papel del área de comunicación en la organización</h1>
      <p class="lead my-3">El rol fundamental del área de comunicación corporativa es liderar la actividad comunicativa de la organización, tanto en el ámbito interno como en el externo.</p>
      <p class="lead mb-0"><a href="#" class="text-white font-weight-bold">Continue Leyendo...</a></p>
      <div id="imagen">
        <img src="https://www.esan.edu.pe/apuntes-empresariales/2016/09/13/compapel_principal.jpg" alt="compapel_principal.jpg" class="img-responsive" width="400px" height="280px">
      </div>
    </div>
  </div>
</div>
